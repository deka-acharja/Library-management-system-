...
class SMTP
{
    ...
    {
        // Check if the level is higher than the current debugging level. If yes, return early.
        if ($level > $this->do_debug) {
            return;
        }
    
        // Check if the Debugoutput property is an instance of PSR-3 LoggerInterface.
        if ($this->Debugoutput instanceof \Psr\Log\LoggerInterface) {
            // If true, call the debug() method on the logger and remove any trailing line breaks.
